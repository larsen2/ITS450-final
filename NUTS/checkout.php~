...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	// Check for Magic Quotes: SQL injection counter-measure --------------------------------------------------- Check ---
	...
	if (isset($_POST['use']) && ($_POST['use'] == 'Y')) {
		...
		$_SESSION['cc_first_name']  = $fn;
		$_SESSION['cc_last_name']  = $ln;
		$_SESSION['cc_address']  = $a1 . ' ' . $a2;
		$_SESSION['cc_city'] = $c;
		$_SESSION['cc_state'] = $s;
		$_SESSION['cc_zip'] = $z;
	}
...
$page_title = 'We Are Nuts - Checkout - Your Shipping Information';
