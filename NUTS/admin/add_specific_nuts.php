<?php
session_start();
// This file allows the administrator to add a specific nut products.
...
// Number of possible specific nutss to add at once:
$count = 10;
...
?><h3>Add Specific Nuts</h3>

<form action="add_specific_nuts.php" method="post" accept-charset="utf-8">

	<fieldset><legend>Fill out the form to add specific nut products to the site.</legend>
		
		<div class="field"><label for="category"><strong>General Nut Type</strong></label><br />
