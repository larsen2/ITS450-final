<?php
session_start();
// This file allows the administrator to add a non-nut product.
...
?><h3>Add a Non-Nut Product (a "Goodie")</h3>

<form enctype="multipart/form-data" action="add_other_products.php" method="post" accept-charset="utf-8">

	<input type="hidden" name="MAX_FILE_SIZE" value="524288" />
	
	<fieldset><legend>Fill out the form to add a non-nut product to the catalog. All fields are required.</legend>
